                    ...
                    <div class="row wishlist-list mt-5 g-5">
                        ...
                        <div class="wishlist  col-12 col-sm-6 col-lg-3">
                            ...
                            <div class="wishlist-title d-flex mt-2">
                                ...
                                <span class="wishlist-button wishlist-edit d-flex justify-content-center align-items-center" data-bs-toggle="modal" data-bs-target="#editModal-{{$wishlist->id}}">
                                    <i class="bi bi-pencil"></i>
                                </span>

                                <span type="submit" class="btn btn-danger wishlist-delete d-flex justify-content-center align-items-center ms-2" data-bs-toggle="modal" data-bs-target="#deleteItem-{{$wishlist->id}}">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="submit" for="create_wishlist" class="btn btn-primary">Save changes</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="editModal-{{ $wishlistItem->id }}" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{route('update', $wishlistItem->id )}}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Wishlist's title</label>
                        <input type="text" name="title" class="form-control" id="title" value="{{ $wishlistItem->title }}">
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<!-- Modal for deleteing -->
<div class="modal fade" id="deleteItem-{{ $wishlistItem->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
